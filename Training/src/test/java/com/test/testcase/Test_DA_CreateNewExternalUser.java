...
public class Test_DA_CreateNewExternalUser {
	
	WebDriver driver;
	String baseUrl = "https://managedservices.qa.lexmark.com";//"https://managedservices.qa.lexmark.com";
	com.PageObject.LogIn_Page login;
	String emailID;
	String lastName;
	com.PageObject.Users_PageObject createUsr;
	Logger logger = Logger.getLogger(Test_DA_CreateNewExternalUser.class);
...
driver = new ChromeDriver();
		...
		login = new com.PageObject.LogIn_Page(driver);
...
@Test 
  public void CreateNewUserTest() throws Exception {
	...
	createUsr = new com.PageObject.Users_PageObject(driver);
