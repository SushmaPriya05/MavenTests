...
@BeforeClass
    ...
    driver = new ChromeDriver();
		...
		logger.info("Browser Launched & navigated to base url");
		 	com.PageObject.LogIn_Page signin = new com.PageObject.LogIn_Page(driver);
...
com.PageObject.PageObject_CreateAddress createNewAddress = new com.PageObject.PageObject_CreateAddress(driver);
createNewAddress.createNewAddress();//To open Create New Address Form
com.PageObject.PageObject_CreateAddress address= new com.PageObject.PageObject_CreateAddress(driver);
...
//######################################### Confirmation/Final Page #######################################
	...
	com.PageObject.dateCalculations dateExpected = new com.PageObject.dateCalculations();
...
public void tearDown() throws Exception{
	driver.manage().timeouts().implicitlyWait(7, TimeUnit.SECONDS);
	  com.PageObject.LogIn_Page logout = new com.PageObject.LogIn_Page(driver); //Logout
	  logout.Logout();
	  logger.info("Log out");
	  driver.quit();
