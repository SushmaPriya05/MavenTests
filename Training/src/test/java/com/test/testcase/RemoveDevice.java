...
public class RemoveDevice {
	...
	com.PageObject.PageObject_RemoveDevice device;
	SoftAssert s_assert =new SoftAssert(); 
	Logger logger = Logger.getLogger(RemoveDevice.class);
@BeforeClass
...
//	logger.info("################# This is REMOVE Device Test ####################");
 ...
 @Test
  public void RemoveDeviceTest() throws Exception{
	  ...
	  device= new com.PageObject.PageObject_RemoveDevice(driver);
